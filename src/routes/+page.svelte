			...
			<div class="testimonials-carousel">
				{#each testimonials as t, i (t.author)}
					<div
						...
						class:prev={i === (currentTestimonial - 1 + testimonials.length) % testimonials.length}
					>
...
<style>
	...
	.feature-card {
		...
		transform: translateY(30px);
		transition:
			opacity 0.8s cubic-bezier(0.2, 0.8, 0.2, 1) calc(var(--i) * 0.1s),
	...
	.step {
		...
		transition:
			opacity 0.7s ease calc(var(--i) * 0.15s),
			transform 0.7s ease calc(var(--i) * 0.15s);
	}
